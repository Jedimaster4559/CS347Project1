...
public class TimeBarController : MonoBehaviour
{
    ...
    public float initialTimeRemaining;
    ...
    void Update()
    {
        ...
        {
            timeRemaining += Time.deltaTime * slowDownFactor;
        }
        if(timeRemaining > initialTimeRemaining)
        {
            timeRemaining = initialTimeRemaining;
        }
        if(timeRemaining < 0 && bulletTimeToggle)
        {
            timeRemaining = 0;
        ...
        timeBar.fillAmount = timeRemaining / initialTimeRemaining;
